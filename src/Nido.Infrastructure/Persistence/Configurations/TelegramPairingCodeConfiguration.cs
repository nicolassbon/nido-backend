...
public sealed class TelegramPairingCodeConfiguration : IEntityTypeConfiguration<TelegramPairingCode>
{
    public void Configure(EntityTypeBuilder<TelegramPairingCode> builder)
    {
        builder.ToTable("telegram_pairing_codes", t =>
        {
            t.HasCheckConstraint(
                "ck_telegram_pairing_codes_attempt_count",
                "attempt_count <= 5");
        });
