...
INSERT INTO ingredientes_receta (id, receta_id, producto_id, nombre_ingrediente, cantidad, unidad) VALUES
    ('77deb818-963f-56e4-b41d-d702e2f64904'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Palta en cubos para decorar', NULL, NULL),
    ('a1253b0a-d2fa-5774-a735-63a4da18a00b'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Microgreens para decorar', NULL, NULL),
    ('64868d1f-81c9-5cbd-b878-15acea5b5801'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Albahaca picada para decorar', NULL, NULL),
    ('e77d1c60-a78a-5150-93b2-24cdd333ada1'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Zanahorias medianas peladas y en cubos', 3, 'unidad'),
    ('0ccb4667-0e40-5b3e-925d-f4eca9649be9'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Tallos de apio en cubos', 3, 'unidad'),
    ('58d81ea8-9609-5028-880e-cb8d65490fe0'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Pechuga de pollo cocida y desmenuzada', 280, 'g'),
    ('93889704-e15d-5ad4-b352-7d92692b4279'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Perejil italiano picado y extra para decorar', 30, 'g'),
    ('e98d9f8b-a6d4-5ebf-95a0-6177b2c5e9b4'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Dientes de ajo bien picados', 6, 'unidad'),
    ('69bf0b6b-76ce-5085-b780-9500083869ee'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Aceite de oliva', 2, 'cda'),
    ('de918cc8-db28-5dec-9e73-41aa1b3dbcae'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Tomates perita en conserva escurridos, enjuagados y picados', 793.787, 'g'),
    ('e8bb37b0-94d2-52a6-981a-1b841905cf0f'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Lentejas rojas secas y enjuagadas', 360, 'g'),
    ('bb0d11db-6502-5068-9d0d-3b727443cde4'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Sal a gusto', NULL, NULL),
    ('819cc8d2-a372-532c-82b0-2154470d1c9c'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Pimienta negra a gusto', NULL, NULL),
    ('5fe707e7-0b66-5b5d-98fc-c3593c053cb6'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Nabo grande pelado y en cubos', 1, 'unidad'),
    ('48bd5123-f35f-5c15-bba6-5be0b34cb839'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Caldo de verduras', 1.88, 'l'),
    ('70343e55-d5b0-59b3-b697-270df993a709'::uuid, '06037ce2-4627-5196-a478-e4ecd537a9bc'::uuid, NULL, 'Cebolla amarilla mediana en cubos', 1, 'unidad'),
    ('37a2f278-4587-5779-a94e-52d33c9fa033'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Aceite vegetal', 1, 'cda'),
    ('15d71b54-97ff-5ba2-8544-892ddc5091e4'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Carne picada vacuna 80/20', 453.592, 'g'),
    ('a46aa9f0-ab87-5224-88d5-b5b22e815093'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Carne picada de cerdo', 453.592, 'g'),
    ('67e75cf8-7c90-54c8-9413-5d8c70e695c6'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Cebolla de verdeo bien picada', 1, 'unidad'),
    ('0fc3882c-fd25-5155-9119-bf598b4f6d67'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Morrón chico bien picado', 1, 'unidad'),
    ('4ff58bec-fab2-5a00-b4bb-af1a6b88e0a3'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Diente de ajo grande machacado', 1, 'unidad'),
    ('9d474937-01c5-5350-8adc-e311275f585b'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Ají molido opcional', 0.25, 'cdta'),
    ('52c3ec33-0806-5a62-88c7-ae1273f9f867'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Sal a gusto para el relleno', NULL, NULL),
    ('7caaf715-a2d7-5424-911d-1a7b51c73c7a'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Pimienta negra a gusto para el relleno', NULL, NULL),
    ('4da45d9f-feaa-5bd3-936c-71aa34042fb3'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Harina común y extra para la superficie', 500, 'g'),
    ('7551d018-3ad9-53da-b3a1-1bc2078a1e2f'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Sal para la masa', 2, 'cdta'),
    ('e8384901-a740-5c80-82b9-3f699c97fe53'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Polvo para hornear', 1, 'cdta'),
    ('07861dcd-f67d-5d04-bd4f-0d7b2d46e02d'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Grasa vegetal', 102.5, 'g'),
    ('8ec8ad60-6355-5f27-89d2-7c60683bf886'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Huevos batidos', 2, 'unidad'),
    ('67c2b4aa-a17f-5cac-a67c-7c9e0218d3cf'::uuid, 'd443984a-eded-590d-8ba7-1c4216aaf5fb'::uuid, NULL, 'Leche', 244, 'ml')
ON CONFLICT (id) DO NOTHING;
...
WHERE id IN ('aefcb56f-88d9-55b1-8b29-27855a28d151', '703d0951-e89f-5fc3-a09b-c0a9b3fd66ec', '6618c204-ff83-5ec5-87b7-a9abc04f2a81', 'db61671a-a9fa-50f6-bbff-8604d0773560', '709b31cd-0d7a-54d8-bd6c-d909f23e2603', '1de21387-806d-5b47-acb3-3a00fb36bf2f', '6546c5e0-9df7-506a-b48d-ed9efcab88fb', '3ef708eb-8f21-5107-95a1-28bfad9e4745', '3426d21e-cac7-5df3-bfdc-a0918ccf5af6', '7862a467-732d-5ac3-91f3-da043d96de5f', 'd42568b3-2b2a-59e7-960a-d70ddd29c39a')
  AND NOT EXISTS (
      SELECT 1
      FROM productos p
      WHERE p.categoria_id = categorias_producto.id
  );
""");
        }
    }
