...
public sealed class TelegramChatNotLinkedException : NidoException
{
    public TelegramChatNotLinkedException()
        : base("TELEGRAM_CHAT_NOT_LINKED",
               "This Telegram chat is not linked to a Nido household.")
    { }
}
...
public sealed class TelegramUpdateAlreadyProcessedException : NidoException
{
    public TelegramUpdateAlreadyProcessedException(long updateId)
        : base("TELEGRAM_UPDATE_ALREADY_PROCESSED",
               $"Telegram update {updateId} has already been processed.")
    { }
}
...
{
    public TelegramPairingTokenAlreadyConsumedException()
        : base("TELEGRAM_PAIRING_TOKEN_ALREADY_CONSUMED",
               "This pairing token has already been consumed.")
    { }
}

public sealed class TelegramPairingCodeExpiredException : NidoException
{
    public TelegramPairingCodeExpiredException()
        : base("TELEGRAM_PAIRING_CODE_EXPIRED",
               "This pairing code has expired. Please request a new one.")
    { }
}

public sealed class TelegramPairingCodeRevokedException : NidoException
{
    public TelegramPairingCodeRevokedException()
        : base("TELEGRAM_PAIRING_CODE_REVOKED",
               "This pairing code was revoked after too many wrong attempts.")
    { }
}

public sealed class TelegramTareaNotAssignedToUserException : NidoException
{
    public TelegramTareaNotAssignedToUserException()
        : base("TELEGRAM_TAREA_NOT_ASSIGNED",
               "This task is not assigned to you; only the assigned user can complete it from Telegram.")
    { }
}
